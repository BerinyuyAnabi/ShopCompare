...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($userType == 'customer') {
            ...
            $userStmt = $conn->prepare("INSERT INTO users (username, email, password_hash, user_type, is_active) VALUES (?, ?, ?, 'customer', 1)");
            ...
            // Insert into users table (created_at auto-generated by DEFAULT CURRENT_TIMESTAMP)
            $userStmt = $conn->prepare("INSERT INTO users (username, email, password_hash, user_type, is_active) VALUES (?, ?, ?, 'shop_owner', 1)");
            $userStmt->bind_param("sss", $username, $email, $passwordHash);
